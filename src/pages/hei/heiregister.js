...
const HeiRegister = () =>{
   ...
   return(
      ...
      <form onSubmit={validate}>
       ...
       cellpadding="10"
       cellspacing="5">
         <tr><th colSpan='2'><center><b>HEI REGISTER</b></center></th></tr>
         <tr className="firstName">
            <th>
            <label className="firstNameLabel" for="NameOfInstitution" >Name of Institution </label>
            </th>
            <td>
            <input className="firstNameInput" type="text" name="NameOfInstitution" placeholder="NameOfInstitution" value={NameOfInstitution} required onChange = {(e) => changeRegisterHandler(e)} ></input> 
            </td>
         </tr>
         <tr className="email">
            <th>
         ...
         <tr className="address">
            ...
            <td>
            <input className="addressInput" type="text" name="address" placeholder="Complete Address" value={addressInput} required onChange = {(e) => changeRegisterHandler(e)} ></input>
            </td>
         </tr>
         ...
         <tr className="Roles">
            ...
            <select className="roleInput" name="role" value={roleInput} required onChange={(e) => changeRegisterHandler(e)} > 
               ...
               <option name="role" value="agencies" >HEI's</option>
               <option name="role" value="hei" >Individual</option>
            </select>
            </td>
         </tr>
